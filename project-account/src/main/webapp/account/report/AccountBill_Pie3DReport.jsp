  ...
  <body>
	...
	<script type="text/javascript"> 
		$(document).ready(function(){
			var chart = new FusionCharts("<%=basePath %>/source/fusioncharts/Pie3D.swf", "ChartId", "560", "400", "0", "0");
			var param = {"name":"summer"};
			$.ajax({
				type: "post",
				async: true,
				data: param,
				url: "<%=basePath%>/AccountMain/AccountBillReportAjax_countConsumptionTypeByPie.action",
				success: function(val){		
							if(val== "error"){
								alert("访问消费类型分布图报表出现错误!");
							}else{
